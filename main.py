...
uploaded_files = st.file_uploader("UNet Segmentation Model", accept_multiple_files=True, type=["png", "jpg", "jpeg"])
...
if st.button("Submit"):
    for uploaded_file in uploaded_files:
        ...
        response = requests.post("http://localhost:1111/model", files=files)
